  ...
  return (
    <FocusRegion compact={compact}>
      ...
      <span style={{display: 'inline-block', margin: '-3px 0', position: 'relative'}}>
        <ValueInput focus withType visible={true} initialType={node.node.name() === 'con' && node.node.view() !== undefined ? 'con' : 'any'} initialValue={value} onSubmit={handleSubmit} onCancel={onCancel} />
